...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 text-background rounded-2xl whitespace-nowrap font-bold border-b-4 border-r-4  transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
